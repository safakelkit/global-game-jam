...
@export var weapon_scenes: Array[String] = [
	...
	"res://objects/gun_mechanics/gun4.tscn",
	"res://objects/gun_mechanics/gun5.tscn"
...
func _ready():
	...
	if hand:
		print("Hand düğümü bulundu:", hand)
	else:
		print("Hand düğümü bulunamadı!")
	
	weapon_changing_timer.wait_time = 0.3  # 5 saniye bekleme süresi
	
	# Başlangıç silahını yükle
	if StartingWeapon:
		print("StartingWeapon yüklendi:", StartingWeapon)
		equip_weapon(StartingWeapon)
	else:
		print("StartingWeapon bulunamadı!")
...
func shoot():
	if equipped_weapon and equipped_weapon.has_method("shoot"):
		...
		print("Shoot fonksiyonu bulunamadı veya equipped_weapon yok!")
func change_weapon():
	print("Change weapon fonksiyonu çağrıldı!")  # Debug için
